...
public class OopFeaturesAndPolymorphism {
    ...
    static class BankAccount {
        ...
        private double balance; // 私有属性，保护内部数据
        ...
        public void withdraw(double amount) {
            if (amount > 0 && amount <= this.balance) {
                ...
                System.out.println("   [封装安全拦截] 提现失败：余额不足或金额非法！");
            }
        }
    ...
    /**
     * 辅助支付接口与实现类：演示多态解决 if-else 开闭原则
     */
    ...
    static class AlipayService implements PaymentService {
        ...
        public void pay(double amount) {
            System.out.println("   [支付宝支付] 成功扣款: " + amount + " 元");
        }
    }
    ...
    static class WechatPayService implements PaymentService {
        @Override
        public void pay(double amount) {
            System.out.println("   [微信支付] 成功扣款: " + amount + " 元");
        }
    }
